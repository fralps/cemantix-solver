...
with open('dictionnaries/en/en_tiny_list.txt') as file:
  line = file.readline()
  while line:
    line = file.readline()
...
def send_to_notion(word, time, count):
  ...
  HEADERS =  {'Authorization': f"Bearer {CEMANTLE_NOTION_TOKEN}", 'Content-Type': 'application/json' ,'Notion-Version': '2021-08-16'}
